...
│
├── app.py                # main app
├── requirements.txt      # zoznam zavislosti
├── uploads/              # nahraté PDF subory
│
├── templates/
│   └── index.html        
│
...
Pred spustením je potrebné mať nainštalovane requirements ktoré sú listed v requirements.txt
...
### Následne otvor webový prehliadač a prejdite na adresu:

http://127.0.0.1:5000

Aplikácia sa zobrazí vo webovom rozhraní, kde je možné nahrávať PDF súbory a spracovať ich.
